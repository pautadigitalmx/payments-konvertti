...
function redirectToLoginPath(request, params) {
    ...
    if (pathname.endsWith(config.auth.loginPath)) {
        const message = `Detected call to shopify.authenticate.admin() from configured login path ` +
...
export { validateShopAndHostParams };
//# sourceMappingURL=validate-shop-and-host-params.mjs.map
