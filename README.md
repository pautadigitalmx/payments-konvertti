...
### Accessing the login prompt

- Open the root page (e.g., `http://localhost:8000/`).
- Log in with the default credentials `admin` / `admin`.
- After logging in, enter the Shopify store domain (e.g., `mystore.myshopify.com`) where you intend to install the app to continue through your OAuth/install flow.
